...
function openDb() {
    ...
    request.onupgradeneeded = function (event) {
        ...
        store.put({filepath: "C:\\Interrobang\\" + currentUser + "&gt;", filename: "SuperUser", content: "Folder", filesize: 0});
        ...
        storeUserDirectory.put({filepath: "C:\\Interrobang\\" + currentUser + "\Results&gt;", filename: "Results", content: "Folder", filesize: 0});
        storeUserDirectory.put({filepath: "", filename: "Bank.CSV", content: "100, -50, 200, 300, -1000, 2000, 100, -50, 200, 300, -1000, 2000, 100, -50, 200, 300, -1000, 2000, 100, -50, 200, 300, -1000, 2000, 100, -50, 200, 300, -1000, 2000, 100, -50, 200, 300, -1000, 2000, 100, -50, 200, 300, -1000, 2000", filesize: 0});
        storeUserDirectory.put({filepath: "", filename: "password.CSV", content: "popchiek:hi,gamrgod88:l337420,slides:mcgee,taeyona:taeyona,thommy:commie", filesize: 0});
        storeUserDirectory.put({filepath: "", filename: "read.CSV", content: "1, 2, 4, 6, 7, 11, 3, 2, 7, 9, 10, 3, 4, 11, 5, 7, 8, 10, 1, 5, 7, 4, 7, 10, 11, 12, 13, 5, 7, 8, 100, 11, 12, 32, 200", filesize: 0});
        ...
        storeUserDirectory.put({filepath: "", filename: "stats.CSV", content: "3, 4, 11, 5, 7, 8, 10, 1, 5, 7, 4, 7, 10, 11, 12, 13, 5, 7, 8, 100, 11, 12, 32, 200", filesize: 0});
        storeUserDirectory.put({filepath: "", filename: "commands.CSV", content: "ls   ,   cat script.sh,  man,    vectorp", filesize: 0});
